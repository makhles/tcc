...
Das entidades mostradas, as tabelas \texttt{inscricaoSelecao\_sel}, \texttt{processoSeletivo\_pro} e \texttt{editalProcessoSeletivo\_eps} já existiam no base de dados. As demais entidades atendem aos requisitos 11 e 12 (vide Seção~\ref{sec:requisitos_funcionais}):
...
\begin{itemize}
  ...
  \item \texttt{docProcessoSeletivo\_dps}
  \item \texttt{inscricaoSelecao\_sel} - é a entidade principal da inscrição, onde ficam armazenados os dados pessoais do candidato.
  \item \texttt{processoSeletivo\_pro}
  \item \texttt{editalProcessoSeletivo\_eps}
