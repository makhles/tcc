...
%Ressalta-se que o autor já foi estagiário na SeTIC, e que, durante o período de desenvolvimento deste trabalho, teve bolsa de extensão fornecida pela FEESC.
...
A camada EIS (\emph{Enterprise Information System}) consiste de servidores de bancos de dados, sistemas de planejamento de recursos empresariais e outras fontes de dados legados \cite{javaee7}. Esses recursos geralmente se localizam em suas próprias máquinas e são acessados pela camada de negócios. As tecnologias utilizadas nessa camada são:
\begin{itemize}
...
\begin{figure}[!ht]
  ...
  \end{center}
  \fonte{Caelum. Adaptado de \citeonline{caelum}}
\end{figure}
...
Dentre suas vantagens, \citeonline{javaee7} destacam:
\begin{itemize}
...
\begin{figure}[!ht]
  ...
  \begin{center}
    ...
    \includegraphics[width=1.0\textwidth]{/uml/er_storage.pdf}
  \end{center}
  \fonte{Elaborada pelo autor.}%
\end{figure}
...
\begin{quadro}[!htb]
  \IBGEtab{%
    ...
    \begin{tabular}{|l|l|}
      ...
      \hline
      Baixar documento     & \texttt{documentos\_enviados.xhtml} \\
      \hline
...
% ----------------------------------------------------------
\noindent
\fbox{\includegraphics[width=1.0\textwidth]{comprovante.pdf}}
