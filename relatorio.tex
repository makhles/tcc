...
A Tabela~\ref{tabela-casos-uso} mostra um mapeamento entre os casos de uso identificados para o ator Candidato (vide Seção~\ref{sec:casos_uso}) e as páginas nas quais foram implementados. A implementação de cada item está descrita nas subseções a seguir.
