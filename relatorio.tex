...
A Figura~\ref{fig:dados_pessoais_desktop} exibe os campos da aba \texttt{Dados Pessoais}.
...
\begin{figure}[!ht]
  \caption{\label{fig:contato_desktop} Campos da aba \texttt{Contato}.}
  \begin{center}
...
\begin{figure}[!ht]
  \caption{\label{fig:buscar_documento_desktop} Busca de documentos.}
  \begin{center}
