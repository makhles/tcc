...
\begin{lstlisting}[language=java, caption={Classe ParkingSpace e seus relacionamentos.}, label={alg:entity_employee_bi}]
@Entity
...
\begin{lstlisting}[language=java, caption={Classe Department e seus relacionamentos.}, label={alg:entity_dept}]
@Entity
...
\begin{lstlisting}[language=java, caption={Classe Employee e seus relacionamentos.}, label={alg:entity_employee2}]
@Entity
public class Employee {
